            ...
            public void run() {
                try {
                    ...
                    if (task.params.has("text")) {
                        ...
                        ForgeFile iconFile = 
                            new ForgeFile(ForgeApp.getActivity(), 
                                          task.params.get("icon"));

                        FileInputStream iconStream = 
                            iconFile.fd().createInputStream();
                        ...
                        if (task.params.has("prerendered") && 
                            ...
                            icon =
                                BitmapUtil.scaledDrawableFromStreamWithTint(
